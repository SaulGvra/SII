<?php
 ...
 include('conexion.php');
  ...
  $query = "SELECT asp_nombre, asp_paterno, asp_materno, asp_fecha, asp_telefono, asp_direccion FROM aspirante where asp_cve_aspirante = '$control';";
  ...
  if ($result = $mysqli->query($query)) {
      ...
      {
          $field1name = $row["asp_nombre"];
          $field2name = $row["asp_paterno"];
          $field3name = $row["asp_materno"];
          $field4name = $row["asp_fecha"];
          $field5name = $row["asp_telefono"];
          $field6name = $row["asp_direccion"];
      ...
      <div class="paddingt row ">
            <div class="col-md-7 col-lg-8">
              ...
              <form action="modulos/updateAspirante.php" method="POST" class="needs-validation" novalidate>
                <div class="row g-3">
                  <div class="col-sm-8">
